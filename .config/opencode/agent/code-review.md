...
HIGH
Auth, crypto, external calls, value transfer, validation removal, access control

MEDIUM
Business logic, state changes, new public APIs, error handling

LOW
Comments, tests, UI, logging, formatting
...
Suggested fix: `code` (if applicable)">**[SEVERITY] [PROVABILITY]** Brief description
